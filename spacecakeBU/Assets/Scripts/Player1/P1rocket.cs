...
public class P1rocket : MonoBehaviour 
{
    ...
    [SerializeField] public GameObject Rocket2;
    ...
    {
        if (part1 && part2 && part3 && part4 && part5 && !Rocket2.GetComponent<P2rocket>().playerWon && collision.gameObject.tag == "player1")
        {
            part1 = false;
            part2 = false;
            part3 = false;
            ...
            Player1.GetComponent<P1movement>().allowMovement = false;
        }
    }
